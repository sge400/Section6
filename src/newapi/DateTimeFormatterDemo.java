...
public class DateTimeFormatterDemo {
    ...
    public static void main(String[] args) {
        ...
        String formattedDate1 = localDate.format(dateFormatter); //same result as line 19
        System.out.println(formattedDate1);
        String formattedDate2 = localDate.format(DateTimeFormatter.BASIC_ISO_DATE); //predefined constants
        String formattedDate3 = localDate.format(DateTimeFormatter.ISO_LOCAL_DATE);
        System.out.println(formattedDate2);
        System.out.println(formattedDate3);

        //convert to german standards
