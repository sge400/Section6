...
public class LinkedListIteration {
    ...
    public static void main(String[] args) {
        ...
        while(iterator.hasNext()){ //only in forward direction, element removal only with iterator object
            String countryName = iterator.next();
            System.out.println(countryName.toLowerCase());
        }

        ListIterator<String> listIterator = countryNames.listIterator(); //use ListIterator only when needed
